...
export const INITIAL_CHARACTERS: Character[] = [
  {
    ...
    status: 'ACTIVE',
    image: '/assets/characters/dwi_purnomo_safety.jpg',
    portrait: '/assets/characters/dwi_purnomo_safety.jpg',
    safetyImage: '/assets/characters/dwi_purnomo_safety.jpg',
    racingImage: '/assets/characters/dwi_purnomo.jpg',
  ...
  },
  {
    ...
    zone: 'Welding Body#2 / Under Body',
    status: 'ACTIVE',
    image: '/assets/characters/denny_nurianto_safety.jpg',
    portrait: '/assets/characters/denny_nurianto_safety.jpg',
    safetyImage: '/assets/characters/denny_nurianto_safety.jpg',
    racingImage: '/assets/characters/denny_nurianto.jpg',
    summary: 'Maintenance Team Member assigned to Welding Body#2 / Under Body (Shift RED).',
    specialization: 'Welding Body#2 Under Body Maintenance & Technical Response',
    categories: {
      idea: {
  ...
  },
  {
    ...
    status: 'ACTIVE',
    image: '/assets/characters/aziz_muslim_safety.jpg',
    portrait: '/assets/characters/aziz_muslim_safety.jpg',
    safetyImage: '/assets/characters/aziz_muslim_safety.jpg',
    racingImage: '/assets/characters/aziz_muslim.jpg',
  ...
  },
  {
    ...
    zone: 'Welding Body#2 / Main Body',
    status: 'ACTIVE',
    image: '/assets/characters/pilar_pratama_putra_safety.jpg',
    portrait: '/assets/characters/pilar_pratama_putra_safety.jpg',
    safetyImage: '/assets/characters/pilar_pratama_putra_safety.jpg',
    racingImage: '/assets/characters/pilar_pratama_putra.jpg',
    summary: 'Maintenance Team Member assigned to Welding Body#2 / Main Body (Shift RED).',
    specialization: 'Welding Body#2 Main Body Maintenance & Technical Response',
    categories: {
      idea: {
        ...
        placeholderItems: [
          {
            ...
            status: 'COMPLETED',
            date: '2026-08',
            summary: 'Optimasi aliran overhead conveyor (OHC), eliminasi bottleneck transfer, dan peningkatan kecepatan siklus untuk mendukung target Tact Time 1.57 menit.'
          }
        ]
      },
      safety: {
  ...
  },
  {
    ...
    status: 'ACTIVE',
    image: '/assets/characters/kurdi_kurniawan_safety.jpg',
    portrait: '/assets/characters/kurdi_kurniawan_safety.jpg',
    safetyImage: '/assets/characters/kurdi_kurniawan_safety.jpg',
    racingImage: '/assets/characters/kurdi_kurniawan.jpg',
  ...
  },
  {
    ...
    zone: 'Welding Body#2 / Under Body',
    status: 'ACTIVE',
    image: '/assets/characters/ikhmal_arasyi_safety.jpg',
    portrait: '/assets/characters/ikhmal_arasyi_safety.jpg',
    safetyImage: '/assets/characters/ikhmal_arasyi_safety.jpg',
    racingImage: '/assets/characters/ikhmal_arasyi.jpg',
    summary: 'Maintenance Team Member assigned to Welding Body#2 / Under Body (Shift RED).',
    specialization: 'Welding Body#2 Under Body Maintenance & Technical Response',
    categories: {
      idea: {
  ...
  },
  {
    ...
    status: 'ACTIVE',
    image: '/assets/characters/arli_yulianto_safety.jpg',
    portrait: '/assets/characters/arli_yulianto_safety.jpg',
    safetyImage: '/assets/characters/arli_yulianto_safety.jpg',
    racingImage: '/assets/characters/arli_yulianto.jpg',
  ...
  },
  {
    id: 'c08',
    code: '01931360',
    name: 'MOCHAMAD DENDY AL-GHIFFARI',
    role: 'Team Member',
    department: 'Maintenance',
    unit: 'Shift RED',
    zone: 'Welding Body#2 / Main Body',
    status: 'ACTIVE',
    image: '/assets/characters/mochamad_dendy_safety.jpg',
    portrait: '/assets/characters/mochamad_dendy_safety.jpg',
    safetyImage: '/assets/characters/mochamad_dendy_safety.jpg',
    racingImage: '/assets/characters/mochamad_dendy.jpg',
    summary: 'Maintenance Team Member assigned to Welding Body#2 / Main Body (Shift RED).',
    specialization: 'Welding Body#2 Main Body Maintenance & Technical Response',
    categories: {
      idea: {
...
export const TEAM_LEADERS: TeamLeaderData[] = [
  {
    ...
    unit: 'Shift RED',
    zone: 'Welding Body#2',
    image: '/assets/characters/machrus_safety.jpg',
    isTeamLeader: true,
